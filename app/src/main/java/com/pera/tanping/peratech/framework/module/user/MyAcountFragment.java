...
/**
 */
public class MyAcountFragment extends BaseFragment implements View.OnClickListener {


    @BindView(R.id.ll_account_address)
    EditTitleView llAccountAddress;
    @BindView(R.id.ll_account_name)
    EditTitleView llAccountName;
    @BindView(R.id.ll_account_phone)
    EditTitleView llAccountPhone;
    @BindView(R.id.ll_account_contory)
    EditTitleView llAccountContory;
    ...
    public int getContentResId() {
        return R.layout.fragment_myacount;
    }
    ...
    private void toSave() {
        ...
        if (verity(llAccountAddress,llAccountName,llAccountPhone,llAccountContory,llAccountArea,llAccountDetail)){
            //请求接口
            getActivity().finish();
        }
